...
# Bot Configuration
TOKEN = "8528695397:AAEX0oVUQzZxKlfE4tzYxmI95krguZ0JKgM" #Chage With Your Actul Bot Tokan#
OWNER_ID = 5994305183 #Chage Owner Id #
CHANNEL_USERNAME = "@CodeFlix_Xx"   # botnko ye chnl me admin dedena#
...
async def handle_document(update: Update, context: CallbackContext):
    ...
    try:
        ...
        await update.message.reply_text("𝑨𝒍𝒍 𝑪𝑪\'𝒔 𝑨𝒓𝒆 𝑪𝒉𝒆𝒄𝒌𝒊𝒏𝒈 𝑩𝒐𝒕 𝑩𝒚 @solo_rohan")"
...
💎 𝘽𝙤𝙩 𝘽𝙮 ➜ @solo_rohan
☑️ 𝙅𝙤𝙞𝙣 𝙊𝙪𝙧 𝘾𝙝𝙖𝙣𝙣𝙚𝙡 𝘼𝙣𝙙 𝙎𝙪𝙥𝙥𝙤𝙧𝙩 ➜ @CodeFlix_Xx
...
async def start_command(update: Update, context: CallbackContext):
    ...
    if not await check_channel_membership(user_id, context):
        keyboard = [
            [InlineKeyboardButton("🔥 𝙅𝙊𝙄𝙉 𝙊𝙐𝙍 𝘾𝙃𝘼𝙉𝙉𝙀𝙇 🔥", url=f"https://t.me/{codeflix_xx[1:]}")],
