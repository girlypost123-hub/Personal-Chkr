...
TOKEN = os.getenv('8517035559:AAGLUsiYHlVWLKv1yaQgoeJHqCRMl-sLxpU')
OWNER_ID_STR = os.getenv('5994305183')
ADMIN_ID_STR = os.getenv('5994305183')
YOUR_USERNAME = os.getenv('@solo_rohan')
UPDATE_CHANNEL = os.getenv('@CodeaFlix_Xx')
...
YOUR_USERNAME = YOUR_USERNAME or '@solo_rohan'
UPDATE_CHANNEL = UPDATE_CHANNEL or 'https://t.me/CodeFlix_Xx'
